...
public class MeterReadingServiceImpl implements MeterReadingService {
    ...
    public MeterReading add(MeterReading mr) {
        ...
        Optional<MeterReading> mrOpt = mrRepo. findByUserIdAndYearAndMonthAndMeterTypeId(
                mr.getUserId(), yearMonth.getYear(), yearMonth.getMonth().getValue(), mr.getMeterTypeId());
        try {
    ...
    public MeterReading getMeterReadingByMonthAndMeterType(UUID userId, YearMonth yearMonth, UUID mrTypeId) {
        Optional<MeterReading> mrOpt = mrRepo
                .findByUserIdAndYearAndMonthAndMeterTypeId(
                        userId, yearMonth.getYear(), yearMonth.getMonth().getValue(), mrTypeId);
        return mrOpt.orElseThrow(
